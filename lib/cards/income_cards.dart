...
class IncomeCard extends StatefulWidget {
  const IncomeCard({super.key, required this.text, required this.amount, this.onTap, this.imagePath, required this.id, required this.index});
  final int id;
  final String text;
  final int amount;
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text('Rs. ${widget.amount == 0 ? '0.00' : moneyFormat(widget.amount.toString())}', style: const TextStyle(fontSize: 15),),
                      ],
                    ),
                  ],
                ),
