...
import 'package:expense_wallet/screens/income_list.dart';
import 'package:expense_wallet/screens/profile_screen.dart';
import 'package:expense_wallet/screens/view_analytics.dart';
...
class FullAccessMainScreen extends StatefulWidget {
  static String mainScreenID = "/full_access_main_screen_screen";

  const FullAccessMainScreen({super.key});
  @override
  _FullAccessMainScreenState createState() => _FullAccessMainScreenState();
}

class _FullAccessMainScreenState extends State<FullAccessMainScreen> {
  ...
  void initState() {
    setState(() {
      for (var element in Constants.typeExpense!) {
        if(element.expenseTypeId == 1 && element.status == 0) {
          general = true;
        }
        if(element.expenseTypeId == 2 && element.status == 0) {
          business = true;
        }
      }
      tabs = [
        const DashboardScreen(),
        const ViewIncomeList(),
        if (general==true || business==true) const Text("message"),
        ViewAnalytics(),
        const ProfileScreen(),
      ];
      print(tabs.length);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: Visibility(
          visible: business == true || general == true ? true: false,
        ...
        bottomNavigationBar: Theme(
          ...
          child: BottomNavigationBar(
            ...
            items: (general || business) ? itemsList1() : itemsList2(),
  ...
  List<BottomNavigationBarItem> itemsList1() {
    return [
  ...
  List<BottomNavigationBarItem> itemsList2(){
    return [
      BottomNavigationBarItem(
          icon: Padding(
            padding: const EdgeInsets.only(top: 3, bottom: 3),
